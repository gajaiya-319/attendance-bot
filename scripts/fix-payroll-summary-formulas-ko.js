...
function currentValues(server, rawTab) {
    return [
        ...
        ['구분', '서버', '총 획득 아데나', '총 급여', '수수료 5%', '직원 70%', '오너 30%', '총 페소'],
        [
            '이번 3일',
            server,
        ...
        requestBody: {
            ...
            data: [
                ...
                },
                {
                    ...
                    values: [
                        ...currentValues('Valacas', 'Valacas 원본'),
                        ['', '', '', '', '', '', '', ''],
                        ['전체 합계', 'Valacas', '=C4', '=D4', '=E4', '=F4', '=G4', '=H4']
                    ]
                },
                {
                    range: "'전체 요약'!A1:H7",
                    values: [
                        ...
                        ['Valacas', "='Valacas 3일정산'!C4", "='Valacas 3일정산'!D4", "='Valacas 3일정산'!E4", "='Valacas 3일정산'!F4", "='Valacas 3일정산'!G4", "='Valacas 3일정산'!H4", ''],
