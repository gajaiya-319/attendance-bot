...
assert.strictEqual(renderer.renderReportMetricHeader(), '점수|이름       |정 결 지 2H 조 연 휴|DC');
assert.strictEqual(renderer.renderReportMetricRow(user), '  25|BitShelby  | 5  2  1  4  1  2  0| 3');
assert.strictEqual(renderer.renderReportStatsLegend(), '순위|이름      |점수|정 결 지 2H 조 연 휴');
assert.strictEqual(renderer.renderReportTopRow(user, 1), '02|BitShelby | 25| 5  2  1  4  1  2  0');
