...
function buildCommandDefinitions() {
    return [
        ...
        new SlashCommandBuilder().setName('역할').setDescription('Assign roles').addUserOption(o=>o.setName('대상').setRequired(true).setDescription('Target')).addStringOption(o=>o.setName('서버').setRequired(true).setDescription('Server').addChoices({name:'발라카스',value:'HEINE'},{name:'Paagrio',value:'PAAGRIO'})).addStringOption(o=>o.setName('시프트').setRequired(true).setDescription('Shift').addChoices({name:'Day',value:'DAY'},{name:'Night',value:'NIGHT'})),
        new SlashCommandBuilder().setName('assign-roles').setDescription('Assign roles').addUserOption(o=>o.setName('target').setRequired(true).setDescription('Target')).addStringOption(o=>o.setName('server').setRequired(true).setDescription('Server').addChoices({name:'발라카스',value:'HEINE'},{name:'Paagrio',value:'PAAGRIO'})).addStringOption(o=>o.setName('shift').setRequired(true).setDescription('Shift').addChoices({name:'Day',value:'DAY'},{name:'Night',value:'NIGHT'})),
        ...
        new SlashCommandBuilder().setName('\uc5d4\ub4dc\uc544\ub370\ub098\ud655\uc778').setDescription('\ubbf8\uc644\ub8cc \uc5d4\ub4dc\uc544\ub370\ub098 \uacb0\uc0b0\uacfc \uc2b9\uc778 \ub300\uae30 \ud56d\ubaa9\uc744 \ud655\uc778\ud569\ub2c8\ub2e4'),
        new SlashCommandBuilder().setName('end-adena-review').setDescription('Review incomplete End Adena reconciliation'),
