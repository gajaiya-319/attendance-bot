...
function buildCommandDefinitions() {
    return [
        ...
        new SlashCommandBuilder().setName('공지설정').setDescription('Schedule announcement').addIntegerOption(o=>o.setName('번호').setRequired(true).setMinValue(1).setMaxValue(6).setDescription('Announcement slot')).addRoleOption(o=>o.setName('대상').setRequired(true).setDescription('First target role')).addRoleOption(o=>o.setName('대상2').setDescription('Second target role')).addStringOption(o=>o.setName('시간').setRequired(true).setDescription('Send time (HH:mm)')).addStringOption(o=>o.setName('내용').setRequired(true).setDescription('Announcement content')),
